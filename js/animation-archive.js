...
tl.from(".navy-bg", 0, {autoAlpha:0, ease: SlowMo.easeIn})
...
.from("#home .jaxx-logo", 0.5, {autoAlpha: 0, y: -10, ease: SlowMo.easeInOut}, "-=0.25")
         
//fade out multi device bg
.to("#home #jaxx-multi-device", 0.5, {autoAlpha:0, display: "none", ease: SlowMo.ease.config(0.1, 0.4, false)}, "-=0.25")

// fade in logo fill 
.to("#home .jaxx-logo .st1", 0.25, {fill:"#ff6902", ease: SlowMo.easeIn}, "-=0.25")
     
// fade in logo fill 
.to("#home .jaxx-logo .st0", 0.25, {fill:"#fff", ease: SlowMo.easeIn})
 
// explode out left JAX
//.to("#home .jaxx-logo .st0", 0.5, {y:1000, display: "none", ease: Power4.easeInOut}, "-=0.25")
.to("#home .jaxx-logo", 0.5, {autoAlpha: 0, display: "none", ease: Power4.easeInOut}, "-=0.25")

// explode out down X
.to("#home .jaxx-logo .st1", 0.5, {x:-1000, display: "none", ease: Power4.easeInOut}, "-=0.25")

// explode out down Liberty
.staggerTo("#home .jaxx-logo .st2", 0.25, {y:-1000, display: "none", ease: Power4.easeInOut}, 0.1)
...
$(document).ready(function(){
  ...
  $("#home a, #contents a").on('click', function(event) {
